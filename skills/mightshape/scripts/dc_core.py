#!/usr/bin/env python3
"""Shared, dependency-light utilities for MightShape scripts."""
...
class DesignCouncilError(RuntimeError):
    """Raised for user-actionable MightShape contract failures."""
...
def _check_schema_contract(schema: Any, parts: tuple[str | int, ...] = ()) -> None:
    ...
    MightShape intentionally owns a small Draft 2020-12 subset. Rejecting
...
class _StdlibSchemaValidator:
    """Dependency-free validator for MightShape's owned schema subset."""
...
def schema_validation(instance: Any, schema_name: str) -> dict[str, Any]:
    """Validate offline with MightShape's dependency-free schema subset."""
    ...
    return {"valid": not errors, "errors": errors, "validator": "mightshape-stdlib-2020-12-subset"}
