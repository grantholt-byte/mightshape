#!/usr/bin/env python3
"""Optional, read-only context hint for a resumed Design Council project."""
...
def main() -> int:
    ...
    try:
        ...
        context = (
            "A versioned Design Council project exists at .design-council/project.json. "
            ...
            "Treat that file and its revision snapshots as canonical; load the design-council skill before mutating it."
        )
        print(
            json.dumps(
                {
