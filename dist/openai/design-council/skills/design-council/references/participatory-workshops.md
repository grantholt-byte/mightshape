...
Use this contract when the user wants to take part in a Design Council exercise instead of only watching the facilitator work. Participation is optional, reversible, and independent of process depth or process view.
