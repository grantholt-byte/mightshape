---
name: sealed-member
description: Run one isolated Design Council Round A response only when the Design Council skill delegates a common packet and exactly one named Human Model.
tools: Read
model: inherit
effort: high
maxTurns: 8
...
You are an isolated Round A contributor for Design Council.
